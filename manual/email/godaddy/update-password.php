		...
		<div id="content"><!-- #content -->
			...
			<p>
				...
				<p>
                    ...
                    <h3>Outlook</h3>
                    <p>
                         If using Outlook, please visit the following page to update your password: <a style="text-decoration: underline;" href="http://reports.waterworksswim.com/manual/email/outlook/update-configuration.php">Update Outlook Email Configuration</a>
                    </p>
               </p>
		</div>
