<?php
	...
	$_SESSION['survey'] = "LA Fitness/City Sports Manager Report";
	$_SESSION['email'] = $email;
	$title = $_SESSION['survey'];
	$process = "send.php";
				...
				<fieldset>
					...
					<?php
						...
						$questions = array(
							...
							"7. What did you do today to improve lesson retention and lesson growth? (that were not included in your submitted shadow logs).",
							"8. What did you do today to improve the performance of the middle and bottom performers? What impact have you seen as a result of this?",
