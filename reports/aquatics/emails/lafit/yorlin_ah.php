<?php
	...
	//mgr.php
	$mgr .= ", justin@waterworksswim.com";

	//mgr_site.php
	$mgrSite .= ", tim@waterworksswim.com, justin@waterworksswim.com";
	...
	//lafit_coor_site.php
	$lafitCoorSite .= ", justin@waterworksswim.com";

	//lafit_lead_inst.php
	$lafitLead .= ", justin@waterworksswim.com, trever@waterworksswim.com, paul@waterworksswim.com";

	//lafit_inst.php
	$lafitInst .= "justin@waterworksswim.com, trever@waterworksswim.com, paul@waterworksswim.com";

	//trainee.php
	$trainee .= ", kelsey.b@waterworksswim.com, tim@waterworksswim.com, justin@waterworksswim.com";

	//maint.php
	$maint .= ", stevisupport@waterworksswim.com, tim@waterworksswim.com";
