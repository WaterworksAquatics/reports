<?php
	...
	//inst.php
	$inst .= "ally@waterworksswim.com";

	//deck_guard_sr.php
	$deckSr .= "ally@waterworksswim.com";

	//deck_guard.php
	$deck .= "ally@waterworksswim.com, franklin@waterworksswim.com";

	//shadow.php
	$shadow .= "kelsey.b@waterworksswim.com, ally@waterworksswim.com, dylinn@waterworksswim.com";

	//play_area.php
	$playArea .= "kelsey.b@waterworksswim.com, ally@waterworksswim.com";

	// eval_deck_guard.php
	$evalDeck .= ", ally@waterworksswim.com, franklin@waterworksswim.com";

	// eval_mock_drown.php
	$evalMock .= ", ally@waterworksswim.com, franklin@waterworksswim.com";
