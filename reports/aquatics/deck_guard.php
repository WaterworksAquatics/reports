<?php
	...
	$survey = "Deck Guard Daily Report";
			...
			<form action='<? echo $process; ?>' method='post'>
				<fieldset>
					...
					<?php
						...
						$questions = array(
							"1. Were there any problems and/or major safety concerns/incidences that occurred in and/or around the pool today? If so, how were they resolved? Did you report them to your manager and/or anyone else?",
