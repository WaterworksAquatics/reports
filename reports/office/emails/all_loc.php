<?php
	...
	// Office List vvv
	// oper_mgr.php
	$operMgr = "jonsupport@waterworksswim.com, toddsupport@waterworksswim.com";

	// area_exp_mgr.php
	$areaExpMgr = "jonsupport@waterworksswim.com, toddsupport@waterworksswim.com";

	// region_exp_mgr.php
	$regExpMgr = "jonsupport@waterworksswim.com, toddsupport@waterworksswim.com, lia@waterworksswim.com, tim@waterworksswim.com";

	// region_qual_mgr.php
	$regQualMgr = "jonsupport@waterworksswim.com, toddsupport@waterworksswim.com, kim@waterworksswim.com, lia@waterworksswim.com, tim@waterworksswim.com";

	// exp_mgr.php
	$expMgr = "jonsupport@waterworksswim.com, toddsupport@waterworksswim.com, kim@waterworksswim.com, lia@waterworksswim.com, tim@waterworksswim.com";

	// region_cust_rltns_mgr.php
	$regCustRltnsMgr = "jonsupport@waterworksswim.com, toddsupport@waterworksswim.com, kim@waterworksswim.com, lia@waterworksswim.com, tim@waterworksswim.com";
	...
	// acc.php
	$acc = "jonsupport@waterworksswim.com, toddsupport@waterworksswim.com, cindysupport@waterworksswim.com";

	// emp_exp_admin.php
	$eea = "toddsupport@waterworksswim.com, shelleysupport@waterworksswim.com";

	// emp_exp_assist.php
	$eeaa = "toddsupport@waterworksswim.com, shelleysupport@waterworksswim.com, kelsey.b@waterworksswim.com";
